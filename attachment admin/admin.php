...
//querying the total number of organizations registered
...
$stmt = $user->runQuery("SELECT *  FROM students");
$stmt->execute();
$stdRow=$stmt->fetchAll(PDO::FETCH_ASSOC);

//querying all the organizations available in the database
$stmt = $user->runQuery("SELECT *  FROM organizations");
$stmt->execute();
$orgRow=$stmt->fetchAll(PDO::FETCH_ASSOC);

//joining data from two table where in both tables there's a similar column
...
<html lang="en">
<head>
    <title>Administrator | strathmore</title>
    <meta charset="utf-8">
   ...
   <link rel="icon" type="image/jpg" size ="96x96" href="images/SU-Logo-1.svg">    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=2 user-scalable=no">
                            ...
                            <div class="form-group">
                                <div class="mt-3">
                                        <label class="col-md-10">
                                            ...
                                            <option value="Social Sciences & Technology">media and communication</option>
                                            <option value="Applied Sciences & Technology">computing and business technology</option>
                                            <option value="Applied Sciences & Technology">business and economics</option>
                                            
                                             <option value="Applied Sciences & Technology">social sciences and technology</option>
                ...
                <div>
                    ...
                    <div id="row" class="card text-center mt-2 float-lg-left col-sm-6 ">
                        ...
                        foreach($engineeringRow as $Row) { ?>
                            <div class="card-body">
                                <h6 class="card-title"> <?php echo $Row['att_title'] ?></h6>
                                <p class="card-text">Organization: <?php echo $Row['org_name']?>  </p>
                                <p class="card-text">Location: <?php echo $Row['org_location'] ?></p>
...
<!--                <div class="col-lg-12">-->
                ...
                <form class="">
                    <table style="background-color: white;width: 100%" class="table table-grey text-black text-center mt-5">
                        ...
                        <thead>
                        <tr>
                            <th style="width: 33%" class="">Admn No.</th>
                            <th style="width: 33%" class="">Course</th>
                            <th style="width: 33%">Organization</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        foreach ($statusRow as $Row) {;?>
                            <tr>
                                <td style="width: 33%"><?php echo $Row['user_admno'] ?></td>
                                <td style="width: 33%"><?php echo $Row['user_course']?></td>
                                <td style="width: 33%;"><?php echo $Row['org_name']?></td>
                            </tr>
                        <?php } } ?>
                        </tbody>
                    </table>
